...
file=open('../summary_data/BCR.Seq.validation.csv',"w")
...
bigdata_imrep.to_csv(path_or_buf='../summary_data/imrep_data.csv', index=False)
...
bigdata_mixcr.to_csv(path_or_buf='../summary_data/mixcr_data.csv', index=False)

file=open('../summary_data/portion.captured.frequency.csv',"w")
