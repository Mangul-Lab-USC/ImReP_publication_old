...
write.gexf(nodes = nodes_df, edges = edges_df, nodesAtt = nodes_att, edgesAtt = edges_att, 
           defaultedgetype = "undirected", output = "../summary_data/IGL_pairs_final.gexf")
...
write.csv(summ_df, '../summary_data/FigureS11_data.csv', row.names=FALSE)
