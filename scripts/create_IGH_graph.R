...
write.gexf(nodes = nodes_df, edges = edges_df, nodesAtt = nodes_att, edgesAtt = edges_att, 
           defaultedgetype = "undirected", output = "../summary_data/IGH_pairs_final.gexf")
...
write.csv(summ_df, '../summary_data/Figure5b_data.csv', row.names=FALSE)
